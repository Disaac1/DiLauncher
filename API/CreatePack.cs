...
public partial class CreatePack : Node
{
    ...
    public static void create(string id)
    {
        ...
        Task task = Task.Run(() =>
        {
            ...
            //OS.CreateInstance(new string[] { "--headless", "--export-pack" });
        });
    }

    public static void setupWorkspace(string id)
    {
        DirAccess files = DirAccess.Open("res://.export/ProjectSettings");
        files.Copy("res://.export/ProjectSettings", "res://Data/" + id);
    }
